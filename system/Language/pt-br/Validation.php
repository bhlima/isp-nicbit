...
return [
	// Core Messages
   'noRuleSets'            => 'Nenhuma regra defina nas configurações de validação.',
   'ruleNotFound'          => '{0} não é uma regra válida.',
   'groupNotFound'         => '{0} não é um grupo de validação.',
   ...
   'numeric'               => 'The {field} pode conter somente numeros.',
   'regex_match'           => 'The {field} não esta no formato correto.',
   ...
   'valid_date'            => 'The {field} field must contain a valid date.',
	...
	// Credit Cards
   'valid_cc_num'          => '{field} não é um número de cartão de crédito válido.',
