...
<?= $this->section('main') ?>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-3">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="<?= site_url('groupsc') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-arrow-left"></i> Voltar</a>
        </div>
    </div>

    <div class="card p-5">
        <form action="<?= site_url('groupsc/update'); ?>" method="POST" accept-charset="UTF-8" onsubmit="Button.disabled = true; return true;">
            <?= csrf_field() ?>
